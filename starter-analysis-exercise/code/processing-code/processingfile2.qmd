...
<span style="color:blue;">
  Additional cleaning on updated raw data.
  `Age` variable treated as numeric (good). No glaring issues with values. 
  Notice variable `Race` is categorical, but is treated as character by R. Let's fix that. 
</span>
