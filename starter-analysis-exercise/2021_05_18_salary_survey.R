...
##the rmd file from google chrome had a .txt on the end of it, so it did not automatically open in R
##I copied and pasted the content from that file and created my own R script, so I could reproduce it
##I should have made it an Rmarkdown file since that is how it is formatted 
...
##tt_load() would not work for me, so I went to the Tidy Tuesday original post and found this line of code to read in the data instead 
